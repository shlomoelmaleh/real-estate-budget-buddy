...
export const translations: Record<Language, Translations> = {
  he: {
    ...
    helperNetIncome: "סכום שכ כבר מנוכה מהחזרי הלוואות קיימות (אם יש).",
    ...
    step1Title: "הבסיס",
    step1Desc: "מי אתם ומה היעד שלכם",
    step2Title: "הדלק",
    step2Desc: "העוצמה הכלכלית וההון העצמי",
    step3Title: "המעטפת",
    step3Desc: "סטטוס, מיסוי וגבולות גזרה",
    step4Title: "הקציר",
    step4Desc: "חשיפת פוטנציאל הרכישה המלא",
    ...
    roadmap1Title: "הבסיס",
    roadmap1Desc: "מי אתם ומה היעד שלכם",
    roadmap2Title: "הדלק",
    roadmap2Desc: "העוצמה הכלכלית וההון העצמי",
    roadmap3Title: "המעטפת",
    roadmap3Desc: "סטטוס, מיסוי וגבולות גזרה",
    roadmap4Title: "הקציר",
    roadmap4Desc: "חשיפת פוטנציאל הרכישה המלא",
    currencySymbol: "₪",
  ...
  en: {
    ...
    step1Title: "The Core",
    step1Desc: "Who you are and your target",
    step2Title: "The Fuel",
    step2Desc: "Financial power and equity",
    step3Title: "The Shield",
    step3Desc: "Status, taxes and constraints",
    step4Title: "The Harvest",
    step4Desc: "Revealing your full potential",
    nextBtn: "Next Step →",
    backBtn: "← Back",
    ...
    roadmap1Title: "The Core",
    roadmap1Desc: "Who you are and your target",
    roadmap2Title: "The Fuel",
    roadmap2Desc: "Financial power and equity",
    roadmap3Title: "The Shield",
    roadmap3Desc: "Status, taxes and constraints",
    roadmap4Title: "The Harvest",
    roadmap4Desc: "Revealing your full potential",
    currencySymbol: "₪",
  ...
  fr: {
    ...
    step1Title: "Le Coeur",
    step1Desc: "Qui vous êtes et votre cible",
    step2Title: "Le Carburant",
    step2Desc: "Puissance financière et apport",
    step3Title: "Le Bouclier",
    step3Desc: "Statut, taxes et limites",
    step4Title: "La Moisson",
    step4Desc: "Révélation de votre potentiel",
    ...
    roadmap1Title: "Le Coeur",
    roadmap1Desc: "Qui vous êtes et votre cible",
    roadmap2Title: "Le Carburant",
    roadmap2Desc: "Puissance financière et apport",
    roadmap3Title: "Le Bouclier",
    roadmap3Desc: "Statut, taxes et limites",
    roadmap4Title: "La Moisson",
    roadmap4Desc: "Révélation de votre potentiel",
    currencySymbol: "₪",
