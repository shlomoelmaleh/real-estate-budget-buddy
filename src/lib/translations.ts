...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    roadmap1Desc: "You and your goal",
    roadmap2Title: "Financial Power",
    roadmap2Desc: "Equity and income",
