...
export const translations: Record<Language, Translations> = {
  he: {
    ...
    step1Desc: "בואו נכיר את בעלי החזון",
    step2Title: "2/4: היסודות",
    step2Desc: "העוצמה הכלכלית שצברתם",
    step3Title: "3/4: התוכנית",
    step3Desc: "פתיחת הדלתות הרגולטוריות עבורכם",
    step4Title: "4/4: השקט הנפשי",
    step4Desc: "הגדרת אזור הנוחות והשלווה שלכם",
    ...
    leadCaptureTitle: "אל תשארו עם מספר בלבד. הכנו עבורכם 'מפת דרכים' אישית של 5 עמודים שתגלה לכם איך להגיע ליעד הזה במינימום ריבית ומקסימום ביטחון. לאן לשלוח לכם אותה?",
    leadCaptureBtn: "שלח לי את האסטרטגיה המלאה",
    wizardWelcome: "ברוכים הבאים! כל חלום גדול מתחיל בתוכנית. בואו נמפה את שלכם.",
    wizardFoundation: "מצוין! העבודה הקשה שלכם בנתה יסודות. בואו נראה לאן הם יכולים לקחת אתכם.",
  ...
  fr: {
    ...
    ltv: "Financement Max",
    netIncome: "Votre puissance financière mensuelle",
    ...
    step1Desc: "Rencontrons les visionnaires",
    step2Title: "2/4: Les Fondations",
    step2Desc: "Votre force financière accumulée",
    step3Title: "3/4: Le Plan",
    step3Desc: "Ouverture de vos portes réglementaires",
    step4Title: "4/4: Sérénité",
    step4Desc: "Définir votre zone de confort et sérénité",
    ...
    leadCaptureTitle: "Ne restez pas avec un simple chiffre. Nous avons préparé votre 'Feuille de Route' personnelle de 5 pages pour atteindre cet objectif avec sécurité. Où devons-nous l'envoyer ?",
