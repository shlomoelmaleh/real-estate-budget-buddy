...
export const translations: Record<Language, Translations> = {
  he: {
    ...
    // Wizard - Hebrew
    step1Title: "החזון: מי אתם ולאן שואפים?",
  ...
  en: {
    ...
    // Wizard - English
    step1Title: "The Vision: Identity & Destination",
    step1Desc: "Let's start with your vision",
    step2Title: "The Foundation",
    step2Desc: "Your financial strength",
    step3Title: "The Blueprint",
  ...
  fr: {
    ...
    // Wizard - French
    step1Title: "La Vision : Identité & Objectif",
    step1Desc: "Commençons par votre vision",
    step2Title: "Vos Moyens",
