...
export const translations: Record<Language, Translations> = {
  he: {
    ...
    roadmap1Title: "החזון",
    roadmap1Desc: "מי אתם ולאן שואפים?",
  ...
  en: {
    ...
    step1Desc: "Who are you and what is the goal?",
    step2Title: "Financial Power",
    step2Desc: "Equity and monthly income",
    step3Title: "Rules & Status",
    step3Desc: "Banking and tax profile",
    step4Title: "Peace of Mind",
    ...
    roadmap1Desc: "Who are you and what is the goal?",
    roadmap2Title: "Financial Power",
    roadmap2Desc: "Equity and monthly income",
    roadmap3Title: "Rules & Status",
    roadmap3Desc: "Banking and tax profile",
    roadmap4Title: "Peace of Mind",
    roadmap4Desc: "Targets and comfort zone",
    currencySymbol: "₪",
  ...
  fr: {
    ...
    step1Desc: "Qui êtes-vous et quel est l'objectif ?",
    step2Title: "Puissance",
    step2Desc: "Apport et revenus mensuels",
    step3Title: "Profil & Règles",
    step3Desc: "Statut bancaire et fiscal",
    step4Title: "Sérénité",
    step4Desc: "Objectifs et zone de confort",
    ...
    roadmap1Desc: "Qui êtes-vous et quel est l'objectif ?",
    roadmap2Title: "Puissance",
    roadmap2Desc: "Apport et revenus mensuels",
    roadmap3Title: "Profil & Règles",
    roadmap3Desc: "Statut bancaire et fiscal",
    roadmap4Title: "Sérénité",
    roadmap4Desc: "Objectifs et zone de confort",
    currencySymbol: "₪",
