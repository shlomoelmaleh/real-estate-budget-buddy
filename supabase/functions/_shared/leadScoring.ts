// ─── LEAD SCORING — Deno-compatible copy of src/lib/leadScoring.ts ────────────
// This is a verbatim copy for use in Supabase Edge Functions (Deno runtime).
// DO NOT modify independently — keep in sync with src/lib/leadScoring.ts.

export const LEAD_SCORE_CONFIG = {
    budget: { platinum: 5_000_000, high: 3_000_000, mid: 1_500_000 },
    dti: { good: 30, ok: 35 },
    equity: { ready: 400_000, min: 200_000 },
    age: { young: 35, mature: 45 },
    liquidity: { comfortable: 200_000, minimal: 50_000 },
};
