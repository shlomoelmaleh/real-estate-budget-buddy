...
export const translations: Record<Language, Translations> = {
  he: {
    ...
    ltv: "מימון מקסימלי",
    netIncome: "הכנסה פנויה נטו (לאחר ניכוי מס והלוואות קיימות)",
    ratio: "יחס החזר",
    ...
    netIncomeLabel: "הכנסה פנויה נטו (לאחר ניכוי מס והלוואות קיימות)",
    ...
    privacyPolicyLink: "/privacy?lang=he",
  ...
  en: {
    ...
    privacyPolicyLink: "/privacy?lang=en",
  ...
  fr: {
    ...
    privacyPolicyLink: "/privacy?lang=fr",
